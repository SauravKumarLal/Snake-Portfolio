...
export const ABOUT_BLURB =
  "Backend Engineer based in Chennai. At Ramco Systems, I own backend systems for the rTask ecosystem, building Kafka-driven distributed services, enterprise OAuth2 and Azure AD integrations, and AI-powered platform capabilities using AWS Bedrock, Claude, and GPT models. My work serves 10,000+ users across 450+ enterprise customers and processes 8-9 lakh API requests daily. I led initiatives that reduced API failures from 8,000 per day to fewer than 20 through deep production debugging and reliability improvements. Previously, I worked as a Research Intern at Samsung R&D Institute, researching GAN-based video generation for real-time chat applications.";
